  ...
  return (
    ...
    <div className='container-sm d-flex align-items-center justify-content-center location-conteiner'>
          ...
          <div className="video-background">
                <video src="./src/assets/Cloudy.mp4"  className="video" type="video/mp4" autoPlay loop muted />
          </div>
          ...
          <div className='d-flex gap-3 justify-content-center conteiner-temp'>
            ...
            <svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-brand-onedrive logo-weather" width="96" height="96" viewBox="0 0 24 24" strokeWidth="1.5" stroke="#ffffff" fill="none" strokeLinecap="round" strokeLinejoin="round">
