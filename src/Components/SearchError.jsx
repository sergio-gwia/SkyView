...
const SearchError = () => {
  return (
    <div className="d-flex  flex-column align-items-center container-sm justify-content-center gap-4">
        ...
        <h2 className='text-light'>No pudimos encontrar tu ciudad, vuelve a intentarlo.</h2>
