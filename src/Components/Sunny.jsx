      ...
      <div className='container-sm d-flex align-items-center justify-content-center location-conteiner'>
          ...
          <div>
            ...
            <div className='d-flex gap-3 justify-content-center conteiner-temp'>
              ...
              <svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-sun-high logo-weather" width="96" height="96" viewBox="0 0 24 24" strokeWidth="1.5" stroke="#ffffff" fill="none" strokeLinecap="round" strokeLinejoin="round">
